...
- **Стартовая страница** — описание проекта, механик и мини-игр для незарегистрированных пользователей; кнопки входа и регистрации в шапке и внизу.
...
```
Стартовая страница (описание проекта, кнопки входа и регистрации)
    │
    ▼
Регистрация
    │
...
│   │       ├── pages/      # LandingPage, AuthPage, GamePage, OnboardingPage
