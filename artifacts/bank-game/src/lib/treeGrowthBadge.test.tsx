...
describe("TreeGrowthBadge on play field", () => {
  ...
  it("CSS places badge to the right of tree wrap; timer mirrors on the left", () => {
    ...
    expect(cssSrc).toMatch(/\.growth-timer\s*\{[^}]*right:\s*100%/s);
    expect(cssSrc).toMatch(/\.growth-timer\s*\{[^}]*top:\s*42%/s);
